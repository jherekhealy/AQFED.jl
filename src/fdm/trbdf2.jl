...
function priceTRBDF2(definition::StructureDefinition,
    ...
    return priceTRBDF2(definition, spot, model, dividends, solverName=solverName, M=M, N=N, ndev=ndev, Smax=Smax, Smin=Smin, dividendPolicy=dividendPolicy, calibration=calibration, varianceConditioner=varianceConditioner)
end
